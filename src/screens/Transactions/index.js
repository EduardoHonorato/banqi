...
export default function fullTransactions({navigation}){
    ...
    return(
       <>
        ...
        {transactions.map((item) =>(
            <TouchableOpacity onPress={()=> navigation.navigate('Details', {transactionId:item._id, title: item.description, description: item.textDescription, amount: numberToMoney(item.amount), date: getParsedDate(item.date), color: item.color})}>
